...
var QTABLE_PATH = path.join(process.cwd(), "data", "qtable.json");
...
var experiences = [];
var EXPERIENCES_PATH = path2.join(process.cwd(), "data", "experiences.json");
var MAX_EXPERIENCES = 1e3;
async function loadExperiences() {
  try {
    await fs2.mkdir(path2.dirname(EXPERIENCES_PATH), { recursive: true });
    const data = await fs2.readFile(EXPERIENCES_PATH, "utf-8");
